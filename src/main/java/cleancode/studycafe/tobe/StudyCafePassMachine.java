...
public class StudyCafePassMachine {
    ...
    public StudyCafePassMachine(SeatPassFileReader seatPassProvider, LockerPassProvider lockerPassProvider) {
    ...
    private StudyCafeSeatPass selectPass() {
        StudyCafePassType passType = ioHandler.selectPassTypeSelecting();
